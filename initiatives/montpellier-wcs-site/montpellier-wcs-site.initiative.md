...
| 10. Build public editorial experience | Homepage, Discover, Start, Community, Visitor and supporting reference pages | Milestones 4–5, 8 | pending | Responsive routes render approved copy/media and pass content/accessibility review |
| 11. Build courses planning and map | Shared filters, search, weekly planning, synchronized map/list, class detail/source links | Milestones 4, 8 | pending | Filter parity tests pass; every visible class maps to one source record |
...
| 13. Build agenda and event details | Date filters, occurrence generation, cancellations/exceptions, event details, sharing, directions and calendar export | Milestones 4, 8 | pending | Timezone/recurrence/cancellation fixtures pass and shared links preserve exact occurrence |
